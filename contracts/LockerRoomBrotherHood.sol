...
contract LockerRoomBrotherHood is ERC721A, Ownable {
  ...
  uint256 private maxReserveCount = 10;
  ...
  constructor(string memory baseURI) ERC721A("Locker Room Brother Hood", "LRBH") {
    setBaseURI(baseURI);
  }
